...
const carBrands: Brand[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { name: "3-Series", code: "E92", hasBodyKit: true },
      ...
      // Hidden: { name: "3-Series", code: "G20 Lci", hasBodyKit: true, hasHoodFender: true, hoodFenderStyle: "CS" },
      { name: "4-Series", code: "F32", hasBodyKit: true },
